...
*/
export const compareEnrollmentPercentage: CourseComparator = (courseA, courseB) => {
  if (
...
*/
export function sortByAttribute(sortAttribute: CourseSortAttribute): CourseComparator {
